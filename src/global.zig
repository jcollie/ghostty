...
pub const GlobalState = struct {
    ...
    logging: Logging,
    journald: if (builtin.os.tag == .linux) ?journalz.Logger else void,
    ...
    pub fn init(self: *GlobalState) !void {
        ...
        self.* = .{
            ...
            .action = null,
            .logging = .stderr,
            .journald = if (builtin.os.tag == .linux) .init("ghostty", .USER) else {},
            .rlimits = .{},
            .resources_dir = .{},
        };
    ...
    pub fn deinit(self: *GlobalState) void {
        ...
        if (builtin.os.tag == .linux) {
            if (self.journald) |logger| logger.deinit();
        }
