...
pub const Application = extern struct {
    ...
    const dbushelper = @import("../dbushelper.zig");

    const DBusObject = dbushelper.Object(Self);

    const dbus_objects: []const DBusObject = &.{
        .{
            .object_path = build_info.object_path,
            .interfaces = &.{
                .{
                    .name = "com.mitchellh.ghostty.Terminals",
                    .methods = &.{
                        .{
                            .name = "ListTerminals",
                            .in_args = &.{},
                            ...
                            .handler = dbusHandleListTerminals,
                        },
                    },
                },
            },
