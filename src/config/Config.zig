...
/// Controls when command finish notifications are sent. There are
/// three options:
///
...
/// If command finish notifications are enabled, this controls how the user is
/// notified.
///
/// Available since 1.3.0.
...
/// If command finish notifications are enabled, this controls how long a command
/// must have been running before a notification will be sent. The default is
/// five seconds.
///
